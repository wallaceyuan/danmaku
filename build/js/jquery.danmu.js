...
;
(function ($) {
    var Danmu = function (element, options,launched) {
        ...
        me.add_to_video = function(danmus){
            for (var i = (danmus.length - 1); i >= 0; i--) {
                ...
                if (danmaku.position == 0) {
                    ...
                    if (nowCount <= maxCount && nowSecCount <= maxCountPerSec) {
                        ...
                        var newSpeed = ($(element).width()+400)/0.09;
                        nowCount++;
                        nowSecCount++;
    ...
    Danmu.prototype.pushCach = function (param) {
        this.launched.push(param);
    };
    ...
    Danmu.prototype.addDanmuReal = function (arg) {
        this.$element.data("danmuList")['real'] = [];
        this.$element.data("danmuList")['real'].push(arg);
        var real = this.$element.data("danmuList")['real'];
        this.add_to_video(real);
    };
